...
Please don't use the issue tracker as a way to ask how to do something. Instead, use the [Forum](https://groups.google.com/forum/#!forum/awx-project), and the `#ansible-awx` channel Matrix to get help.
